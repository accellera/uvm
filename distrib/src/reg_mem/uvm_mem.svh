...
class uvm_mem extends uvm_object;
   ...
   /*local*/ uvm_vreg XvregsX[$]; //Virtual registers implemented here
   ...
   //
   extern virtual function void configure (uvm_reg_mem_block parent,
                                           string        hdl_path = "");

   /*local*/ extern virtual function void set_parent(uvm_reg_mem_block parent);
   ...
   extern virtual function uvm_reg_mem_block get_block  ();
   ...
   //
   extern function         bit             is_in_map       (uvm_reg_mem_map map);
   ...
   /*local*/ extern function uvm_reg_mem_map get_local_map   (uvm_reg_mem_map map,
                                                          string caller = "");
   /*local*/ extern function uvm_reg_mem_map get_default_map (string caller = "");
   ...
   // and "RW" is returned. 
   //
   extern virtual function string          get_rights (uvm_reg_mem_map map = null);
   ...
   //
   extern virtual function string          get_access(uvm_reg_mem_map map = null);
   ...
   //
   extern virtual function uvm_vreg    get_vreg_by_offset(
   ...
   // address map, an error message is issued.
   //
   extern virtual function uvm_reg_mem_addr_t  get_offset (uvm_reg_mem_addr_t offset = 0,
                                                       uvm_reg_mem_map    map = null);
   ...
   // address map, an error message is issued.
   //
   extern virtual function uvm_reg_mem_addr_t  get_address(uvm_reg_mem_addr_t  offset = 0,
                                                       uvm_reg_mem_map   map = null);
   ...
   // address map, an error message is issued.
   //
   extern virtual function int get_addresses(uvm_reg_mem_addr_t     offset = 0,
                                             uvm_reg_mem_map        map=null,
                                             ref uvm_reg_mem_addr_t addr[]);
   ...
   extern virtual task write(output uvm_status_e  status,
                             ...
                             input  uvm_reg_mem_data_t     value,
   ...
   extern virtual task read(output uvm_status_e   status,
                            input  uvm_reg_mem_addr_t      offset,
                            output uvm_reg_mem_data_t      value,
                            input  uvm_path_e     path   = UVM_DEFAULT_PATH,
                            input  uvm_reg_mem_map         map = null,
                            input  uvm_sequence_base   parent = null,
                            input  int                 prior = -1,
   ...
   // must be specified.
   //
   extern function void set_frontdoor(uvm_mem_frontdoor ftdr,
                                      uvm_reg_mem_map        map = null,
                                      string                fname = "",
                                      int                   lineno = 0);
   ...
   // must be specified.
   //
   extern function uvm_mem_frontdoor get_frontdoor(uvm_reg_mem_map map = null);
   ...
   local uvm_mem_backdoor backdoor;
   ...
   // the corresponding memory abstraction class
   //
   extern function void set_backdoor (uvm_mem_backdoor bkdr,
                                      string               fname = "",
                                      int                  lineno = 0);
   ...
   //
   extern function uvm_mem_backdoor get_backdoor();
   ...
   extern local function bit validate_burst(uvm_mem_burst burst);
   ...
   // of this method.
   //
   virtual task pre_write(ref uvm_reg_mem_addr_t   offset,
                          ref uvm_reg_mem_data_t   wdat,
                          ref uvm_path_e  path,
                          ref uvm_reg_mem_map      map);
   endtask
   ...
   // of this method.
   //
   virtual task post_write(uvm_reg_mem_addr_t        offset,
                           uvm_reg_mem_data_t        wdat,
                           uvm_path_e       path,
                           uvm_reg_mem_map           map,
   ...
   // of this method.
   //
   virtual task pre_read(ref uvm_reg_mem_addr_t  offset,
                         ref uvm_path_e path,
                         ref uvm_reg_mem_map     map);
   endtask
   ...
   // of this method.
   //
   virtual task post_read(input uvm_reg_mem_addr_t    offset,
                          ref   uvm_reg_mem_data_t    rdat,
                          input uvm_path_e   path,
                          input uvm_reg_mem_map       map,
                          ref   uvm_status_e status);
   endtask
...
//
class uvm_mem_cbs extends uvm_callback;
   string fname = "";
   int lineno = 0;
   ...
   //
   // The registered callback methods are invoked after the invocation
   // of the <uvm_mem::pre_write()> method.
   //
   ...
   //
   virtual task pre_write(uvm_mem         mem,
                          ref uvm_reg_mem_addr_t  offset,
                          ref uvm_reg_mem_data_t  wdat,
                          ref uvm_path_e path,
                          ref uvm_reg_mem_map     map);
   endtask: pre_write
   ...
   //
   // The registered callback methods are invoked before the invocation
   // of the <uvm_mem::post_write()> method.
   //
   // The ~status~ of the operation,
   // if modified, modifies the actual returned status.
   //
   virtual task post_write(uvm_mem            mem,
                           uvm_reg_mem_addr_t         offset,
                           uvm_reg_mem_data_t         wdat,
                           uvm_path_e        path,
                           uvm_reg_mem_map            map,
   ...
   //
   // The registered callback methods are invoked after the invocation
   // of the <uvm_mem::pre_read()> method.
   //
   ...
   //
   virtual task pre_read(uvm_mem         mem,
                         ref uvm_reg_mem_addr_t  offset,
                         ref uvm_path_e path,
                         ref uvm_reg_mem_map     map);
   endtask: pre_read
   ...
   //
   // The registered callback methods are invoked before the invocation
   // of the <uvm_mem::post_read()> method.
   //
   ...
   //
   // The registered callback methods are invoked after the invocation
   // of the <uvm_mem::pre_burst()> method.
   //
   // The ~burst~, written values, access ~path~ and address ~map~,
   // if modified, modifies the actual offset, value, access path or address map
   // used in the memory operation.
   //
   virtual task pre_burst(uvm_mem              mem,
   ...
   //
   // The registered callback methods are invoked before the invocation
   // of the <uvm_mem::post_burst()> method.
   //
   // The readback value ~rdat~ and the ~status~ of the operation,
   // if modified, modifies the actual returned readback value and status.
   //
   virtual task post_burst(input uvm_mem             mem,
...
//
typedef uvm_callbacks#(uvm_mem, uvm_mem_cbs) uvm_mem_cb;
...
//
typedef uvm_callback_iter#(uvm_mem, uvm_mem_cbs) uvm_mem_cb_iter;



//
// CLASS: uvm_mem_frontdoor
...
//
virtual class uvm_mem_frontdoor extends uvm_sequence #(uvm_sequence_item);
...
function uvm_mem::new (string           name,
   ...
   this.locked = 0;
   if (n_bits == 0) begin
      `uvm_error("RegMem", {"Memory '",get_full_name(),"' cannot have 0 bits"})
      n_bits = 1;
   end
   if (n_bits > `UVM_REG_MEM_DATA_WIDTH) begin
      `uvm_error("RegMem",
          $psprintf("Memory \"%s\" cannot have more than %0d bits (%0d)",
                   this.get_full_name(), `UVM_REG_MEM_DATA_WIDTH, n_bits))
      n_bits = `UVM_REG_MEM_DATA_WIDTH;
   end
   this.size      = size;
   this.n_bits    = n_bits;
   this.backdoor  = null;
...
function void uvm_mem::configure(uvm_reg_mem_block  parent,
                                     string         hdl_path="");
   ...
   if (this.access != "RW" && this.access != "RO") begin
      `uvm_error("RegMem", {"Memory '",get_full_name(),"' can only be RW or RO"})
      this.access = "RW";
   end
...
function void uvm_mem::add_map(uvm_reg_mem_map map);
  if (!maps.exists(map))
    maps[map] = 1;
endfunction
...
function uvm_reg_mem_block uvm_mem::get_block();
...
function void uvm_mem::get_maps(ref uvm_reg_mem_map maps[$]);
...
function bit uvm_mem::is_in_map(uvm_reg_mem_map map);
   if (maps.exists(map))
     return 1;
...
function uvm_reg_mem_map uvm_mem::get_local_map(uvm_reg_mem_map map, string caller="");
   if (map == null)
...
function uvm_reg_mem_map uvm_mem::get_default_map(string caller="");
   ...
   foreach (maps[map]) begin
     ...
     if (default_map != null) begin
       uvm_reg_mem_map local_map = get_local_map(default_map);
       if (local_map != null)
         return local_map;
     end
   end
...
function string uvm_mem::get_access(uvm_reg_mem_map map = null);
...
function string uvm_mem::get_rights(uvm_reg_mem_map map = null);

   uvm_reg_mem_map_info info;
...
function uvm_reg_mem_addr_t uvm_mem::get_offset(uvm_reg_mem_addr_t offset = 0,
                                                uvm_reg_mem_map map = null);

   uvm_reg_mem_map_info map_info;
   uvm_reg_mem_map orig_map = map;
   ...
   if (map_info.unmapped) begin
      `uvm_warning("RegMem", {"Memory '",get_name(),
                   "' is unmapped in map '",
...
function uvm_vreg_field uvm_mem::get_vfield_by_name(string name);
  ...
  `uvm_warning("RegMem", {"Unable to find virtual field '",name,
...
function uvm_vreg uvm_mem::get_vreg_by_name(string name);
  ...
  `uvm_warning("RegMem", {"Unable to find virtual register '",name,
                       "' in memory '",get_full_name(),"'"})
  return null;
...
function uvm_vreg uvm_mem::get_vreg_by_offset(bit [63:0] offset,
                                                      uvm_reg_mem_map map = null);
...
function int uvm_mem::get_addresses(uvm_reg_mem_addr_t offset = 0, uvm_reg_mem_map map=null, ref uvm_reg_mem_addr_t addr[]);

   uvm_reg_mem_map_info map_info;
   uvm_reg_mem_map system_map;
   uvm_reg_mem_map orig_map = map;
...
function uvm_reg_mem_addr_t uvm_mem::get_address(uvm_reg_mem_addr_t offset = 0, uvm_reg_mem_map map = null);
   uvm_reg_mem_addr_t  addr[];
...
function void uvm_mem::set_attribute(string name,
                                         string value);
   if (name == "") begin
      `uvm_error("RegMem", {"Cannot set anonymous attribute \"\" in memory '",
                         get_full_name(),"'"})
      return;
   end
   ...
   if (this.attributes.exists(name)) begin
      if (value != "") begin
         `uvm_warning("RegMem", {"Redefining attribute '",name,"' in memory '",
...
function int uvm_mem::set_cover(int is_on);
   ...
   if (is_on & UVM_ADDR_MAP) begin
      if (this.has_cover & UVM_ADDR_MAP) begin
          ...
          `uvm_warning("RegMem", $psprintf("\"%s\" - Cannot turn ON Address Map coverage becasue the corresponding coverage model was not generated.", this.get_full_name()));
      end
   end else begin
      return this.cover_on;
   end
...
task uvm_mem::write(output uvm_status_e status,
   ...
   uvm_reg_mem_map local_map, system_map;
   uvm_reg_mem_map_info map_info;
   ...
   for (uvm_mem_cbs cb = cbs.first(); cb != null;
        cb = cbs.next()) begin
      cb.fname = this.fname;
   ...
   case (path)
      ...
      UVM_BFM: begin
         ...
         if (map_info.mem_frontdoor != null) begin
            uvm_mem_frontdoor fd = map_info.mem_frontdoor;
            fd.mem       = this;
            fd.is_write  = 1;
            fd.burst     = null;
            fd.offset    = offset;
         ...
         // ...VIA BUILT-IN FRONTDOOR
            ...
            if ($cast(passthru_adapter,adapter))
              is_passthru = 1;
            if (map_info.unmapped) begin
               `uvm_error("RegMem", {"Memory '",get_full_name(),"' unmapped in map '",
            ...
            foreach (addr[i]) begin
               ...
               if (status != UVM_IS_OK && status != UVM_HAS_X) break;
               j += w;
               n_bits -= w * 8;
            end
         end
...
task uvm_mem::read(output uvm_status_e  status,
   ...
   `uvm_info("RegMem", $psprintf("Read memory \"%s\"[%0d] via %s: 'h%h",
                              this.get_full_name(), offset,
                              (path == UVM_BFM) ? {"map ",map.get_full_name()} : "backdoor",
                              value),UVM_MEDIUM);
...
function bit uvm_mem::validate_burst(uvm_mem_burst burst);
   if (burst.start_offset >= this.get_size()) begin
      `uvm_error("RegMem", $psprintf("Starting burst offset 'h%0h is greater than number of memory locations ('h%0h)",
                                     burst.start_offset, this.get_size()));
      return 0;
   end

   if (burst.max_offset >= this.get_size()) begin
      `uvm_error("RegMem", $psprintf("Maximum burst offset 'h%0h is greater than number of memory locations ('h%0h)",
                                     burst.max_offset, this.get_size()));
      return 0;
   end

   if (burst.n_beats == 0) begin
      `uvm_error("RegMem", "Zero-length burst");
      return 0;
   end

   if (burst.start_offset > burst.max_offset) begin
      `uvm_error("RegMem", $psprintf("Starting burst offset ('h%0h) greater than maximum burst offset ('h%0h)",
   ...
   if (burst.n_beats > 1 &&
      ...
      `uvm_error("RegMem", $psprintf("First burst offset increment 'h%0h+%0h is greater than maximum burst offset ('h%0h)",
   ...
   case (path)
      ...
      UVM_BFM: begin
         ...
         // ...VIA BUILT-IN FRONTDOOR
            ...
            if (n_bits > w*8) begin
               `uvm_error("RegMem", $psprintf("Cannot burst-write a %0d-bit memory through a narrower data path (%0d bytes)",
                                              n_bits, w));
               return;
            end
            // Translate offsets into addresses
            begin
               uvm_reg_mem_addr_t  start, incr, max;
...
task uvm_mem::poke(output uvm_status_e status,
   ...
   if (this.backdoor == null && !has_hdl_path(kind)) begin
      `uvm_error("RegMem", $psprintf("No backdoor access available in memory %s", this.get_full_name()));
      status = UVM_NOT_OK;
      return;
   end
...
function void uvm_mem::set_frontdoor(uvm_mem_frontdoor ftdr,
                                         uvm_reg_mem_map           map = null,
                                         string                fname = "",
                                         int                   lineno = 0);
   uvm_reg_mem_map_info map_info;
   ...
   if (map == null) begin
      `uvm_error("RegMem", {"Memory '",get_full_name(),
...
function uvm_mem_frontdoor uvm_mem::get_frontdoor(uvm_reg_mem_map map = null);
   uvm_reg_mem_map_info map_info;
...
function void uvm_mem::set_backdoor(uvm_mem_backdoor bkdr,
                                        string               fname = "",
                                        int                  lineno = 0);
   this.fname = fname;
   this.lineno = lineno;
...
function uvm_mem_backdoor uvm_mem::get_backdoor();
...
function uvm_status_e  uvm_mem::backdoor_read_func(
                    input uvm_reg_mem_addr_t    offset,
                    output uvm_reg_mem_data_t   data,
                    input string             kind,
                    input uvm_sequence_base parent,
  ...
  foreach (paths[i]) begin
     ...
     if (val != data) begin
        `uvm_error("RegMem", $psprintf("Backdoor read of register with multiple HDL copies: values are not the same: %0h at path '%s', and %0h at path '%s'. Returning first value.",
                                    this.get_full_name(),
...
task uvm_mem::backdoor_read( output uvm_status_e status,
                                 input uvm_reg_mem_addr_t     offset,
                                 output uvm_reg_mem_data_t    data,
                                 input string             kind,
                                 input uvm_sequence_base  parent,
...
task uvm_mem::backdoor_write(output uvm_status_e status,
                                 input uvm_reg_mem_addr_t     offset,
                                 input uvm_reg_mem_data_t     data,
                                 input string             kind,
                                 input uvm_sequence_base  parent,
...
function void uvm_mem::get_hdl_path(ref uvm_hdl_path_concat paths[$],
  ...
  if (!has_hdl_path(kind)) begin
    `uvm_error("RegMem",{"Memory does not have hdl path defined for abstraction '",kind,"'"})
    return;
  end
...
function void uvm_mem::set_parent(uvm_reg_mem_block parent);
  this.parent = parent;
endfunction
...
function uvm_reg_mem_block uvm_mem::get_parent();
   return get_block();
endfunction
...
function string uvm_mem::convert2string();
   ...
   foreach (this.maps[map]) begin
     uvm_reg_mem_map parent_map = map;
     int unsigned offset;
     while (parent_map != null) begin
       uvm_reg_mem_map this_map = parent_map;
...
function uvm_object uvm_mem::clone();
  `uvm_fatal("RegMem","RegMem memories cannot be cloned")
  return null;
endfunction
...
function void uvm_mem::do_copy(uvm_object rhs);
  `uvm_fatal("RegMem","RegMem memories cannot be copied")
endfunction
...
function bit uvm_mem::do_compare (uvm_object  rhs,
                                        uvm_comparer comparer);
  `uvm_warning("RegMem","RegMem memories cannot be compared")
  return 0;
endfunction
...
function void uvm_mem::do_pack (uvm_packer packer);
  `uvm_warning("RegMem","RegMem memories cannot be packed")
endfunction
...
function void uvm_mem::do_unpack (uvm_packer packer);
  `uvm_warning("RegMem","RegMem memories cannot be unpacked")
endfunction
