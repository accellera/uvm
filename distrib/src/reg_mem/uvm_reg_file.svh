...
function uvm_reg_mem_block uvm_reg_file::get_block();
...
function void uvm_reg_file::get_full_hdl_path(ref string paths[$], input string kind = "");
   ...
   if (!has_hdl_path(kind)) begin
      `uvm_error("RegMem",{"Register file does not have hdl path defined for abstraction '",kind,"'"})
      return;
   end
...
function void uvm_reg_file::set_default_hdl_path(string kind);
  ...
  if (kind == "") begin
    if (m_rf != null)
      ...
      `uvm_error("RegMem",{"Register file has no parent. ",
...
function uvm_reg_mem_block uvm_reg_file::get_parent();
  return get_block();
endfunction
...
function string uvm_reg_file::convert2string();
  `uvm_fatal("RegMem","RegMem register files cannot be converted to strings")
   return "";
...
function uvm_object uvm_reg_file::clone();
  `uvm_fatal("RegMem","RegMem register files cannot be cloned")
  return null;
endfunction
...
function void uvm_reg_file::do_copy(uvm_object rhs);
  `uvm_fatal("RegMem","RegMem register files cannot be copied")
endfunction
...
function bit uvm_reg_file::do_compare (uvm_object  rhs,
                                        uvm_comparer comparer);
  `uvm_warning("RegMem","RegMem register files cannot be compared")
  return 0;
endfunction
...
function void uvm_reg_file::do_pack (uvm_packer packer);
  `uvm_warning("RegMem","RegMem register files cannot be packed")
endfunction
...
function void uvm_reg_file::do_unpack (uvm_packer packer);
  `uvm_warning("RegMem","RegMem register files cannot be unpacked")
endfunction
