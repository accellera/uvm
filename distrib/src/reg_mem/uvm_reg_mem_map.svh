...
//
// Address maps are created using the <uvm_reg_mem_block::create_map()>
// method.
//
class uvm_reg_mem_map extends uvm_object;

   `uvm_object_utils(uvm_reg_mem_map)
   
   // info that is valid only if top-level map
   local int unsigned            m_n_bytes;
   local uvm_endianness_e   m_endian;
   local uvm_reg_mem_addr_t          m_base_addr;
   local uvm_object_wrapper      m_sequence_wrapper;
   local uvm_reg_adapter         m_adapter;
   local uvm_sequencer_base      m_sequencer;
   local bit                     m_auto_predict;

   local uvm_reg_mem_block           m_parent;

   local int unsigned            m_system_n_bytes;

   local uvm_reg_mem_map             m_parent_map;
   local uvm_reg_mem_addr_t          m_parent_maps[uvm_reg_mem_map];   // value=offset of this map at parent level
   local uvm_reg_mem_addr_t          m_submaps[uvm_reg_mem_map];       // value=offset of submap at this level
   local string                  m_submap_rights[uvm_reg_mem_map]; // value=rights of submap at this level

   local uvm_reg_mem_map_info        m_regs_info[uvm_reg];
   local uvm_reg_mem_map_info        m_mems_info[uvm_mem];

   local string                  m_attributes[string];

   local uvm_reg             m_regs_by_offset[uvm_reg_mem_addr_t];
   local uvm_mem             m_mems_by_offset[uvm_reg_mem_addr_t];

   extern /*local*/ function void Xinit_address_mapX();

   static local uvm_reg_mem_map   m_backdoor;
   static function uvm_reg_mem_map backdoor();
      if (m_backdoor == null)
   ...
   /*local*/ extern function void configure(uvm_reg_mem_block          parent,
   ...
   //
   extern virtual function void   add_submap    (uvm_reg_mem_map    child_map,
                                                 uvm_reg_mem_addr_t offset);

   extern virtual function void   set_sequencer (uvm_sequencer_base sequencer,
                                                 uvm_reg_adapter    adapter);

   extern virtual function void           set_submap_offset (uvm_reg_mem_map submap,
                                                             uvm_reg_mem_addr_t offset);
   ...
   /*local*/ extern function bit Xcheck_child_overlapX(uvm_reg_mem_map  child_map,
                                                       int unsigned offset,
                                                       int unsigned size);
   ...
   // in the sub-maps.
   //
   extern virtual function void  get_submaps           (ref uvm_reg_mem_map maps[$],      input uvm_hier_e hier=UVM_HIER);
   ...
   extern virtual function uvm_reg_mem_map_info get_reg_map_info(uvm_reg rg,  bit error=1);
   extern virtual function uvm_reg_mem_map_info get_mem_map_info(uvm_mem mem, bit error=1);
   ...
   extern virtual function int get_physical_addresses(uvm_reg_mem_addr_t        base_addr,
                                                      uvm_reg_mem_addr_t        mem_offset,
                                                      int unsigned          n_bytes,
...
function uvm_reg_mem_map::new(string name = "");
...
function void uvm_reg_mem_map::configure(uvm_reg_mem_block          parent,
                                     uvm_reg_mem_addr_t         base_addr,
                                     int unsigned           n_bytes,
                                     uvm_endianness_e  endian);
   m_parent     = parent;
...
function void uvm_reg_mem_map::add_reg(uvm_reg rg, 
                                   uvm_reg_mem_addr_t offset,
                                   string rights = "RW",
                                   bit unmapped=0,
                                   uvm_reg_frontdoor frontdoor=null);
...
function void uvm_reg_mem_map::add_mem(uvm_mem mem,
                                   uvm_reg_mem_addr_t offset,
                                   string rights = "RW",
                                   bit unmapped=0,
                                   uvm_mem_frontdoor frontdoor=null);
...
function void uvm_reg_mem_map::add_submap (uvm_reg_mem_map child_map,
   ...
   if (parent_map != null) begin
      `uvm_error("RegMem", {"Map '", child_map.get_full_name(),
   ...
   begin : parent_block_check
     uvm_reg_mem_block blk = child_map.get_parent();
     if (blk == null) begin
        `uvm_error("RegMem", {"Cannot add submap '",child_map.get_full_name(),
...
function void uvm_reg_mem_map::add_parent_map(uvm_reg_mem_map parent_map, uvm_reg_mem_addr_t offset);
...
function void uvm_reg_mem_map::set_sequencer(uvm_sequencer_base sequencer,
                                         uvm_reg_adapter adapter);
...
function uvm_reg_mem_block uvm_reg_mem_map::get_parent();
  return m_parent;
endfunction
...
function uvm_reg_mem_map uvm_reg_mem_map::get_parent_map();
  return m_parent_map;
endfunction
...
function uvm_reg_mem_map uvm_reg_mem_map::get_root_map();
...
function uvm_reg_mem_addr_t  uvm_reg_mem_map::get_base_addr(uvm_hier_e hier=UVM_HIER);
  uvm_reg_mem_map child = this;
...
function int unsigned uvm_reg_mem_map::get_n_bytes(uvm_hier_e hier=UVM_HIER);
  if (hier == UVM_NO_HIER)
    return m_n_bytes;
...
function uvm_endianness_e uvm_reg_mem_map::get_endian(uvm_hier_e hier=UVM_HIER);
  if (hier == UVM_NO_HIER || m_parent_map == null)
    return m_endian;
...
function uvm_sequencer_base uvm_reg_mem_map::get_sequencer(uvm_hier_e hier=UVM_HIER);
  if (hier == UVM_NO_HIER || m_parent_map == null)
    return m_sequencer;
...
function uvm_reg_adapter uvm_reg_mem_map::get_adapter(uvm_hier_e hier=UVM_HIER);
  if (hier == UVM_NO_HIER || m_parent_map == null)
    return m_adapter;
...
function void uvm_reg_mem_map::get_submaps(ref uvm_reg_mem_map maps[$], input uvm_hier_e hier=UVM_HIER);
...
function void uvm_reg_mem_map::get_registers(ref uvm_reg regs[$], input uvm_hier_e hier=UVM_HIER);
...
function void uvm_reg_mem_map::get_fields(ref uvm_reg_field fields[$], input uvm_hier_e hier=UVM_HIER);
...
function void uvm_reg_mem_map::get_memories(ref uvm_mem mems[$], input uvm_hier_e hier=UVM_HIER);
...
function void uvm_reg_mem_map::get_virtual_registers(ref uvm_vreg regs[$], input uvm_hier_e hier=UVM_HIER);
...
function void uvm_reg_mem_map::get_virtual_fields(ref uvm_vreg_field fields[$], input uvm_hier_e hier=UVM_HIER);
...
function string uvm_reg_mem_map::get_full_name();
...
function uvm_reg_mem_map_info uvm_reg_mem_map::get_mem_map_info(uvm_mem mem, bit error=1);
...
function uvm_reg_mem_map_info uvm_reg_mem_map::get_reg_map_info(uvm_reg rg, bit error=1);
...
function void uvm_reg_mem_map::set_base_addr(uvm_reg_mem_addr_t offset);
   if (m_parent_map != null) begin
      uvm_reg_mem_map top_map = get_root_map();
...
function int unsigned uvm_reg_mem_map::get_size();
...
function bit uvm_reg_mem_map::Xcheck_rangeX(int unsigned str_addr,
                                        int unsigned end_addr,
                                        string kind,
                                        int unsigned new_str_addr,
                                        int unsigned new_end_addr,
...
function bit uvm_reg_mem_map::Xcheck_child_overlapX(uvm_reg_mem_map  child_map,
                                                int unsigned offset,
                                                int unsigned size);
...
function void uvm_reg_mem_map::Xverify_map_configX();
   ...
   if (error) begin
      `uvm_fatal("RegMem", {"Must register an adapter and sequencer ",
                 "for each top-level map in RegMem model"});
      return;
   end
...
function int uvm_reg_mem_map::get_physical_addresses(uvm_reg_mem_addr_t     base_addr,
                                                 uvm_reg_mem_addr_t     mem_offset,
                                                 int unsigned       n_bytes,
                                                 ref uvm_reg_mem_addr_t addr[]);
   int bus_width = get_n_bytes(UVM_NO_HIER);
   uvm_reg_mem_map  up_map;
   uvm_reg_mem_addr_t  local_addr[];

   addr = new [0];
   
   if (n_bytes <= 0) begin
      `uvm_fatal("RegMem", $psprintf("Cannot access %0d bytes. Must be greater than 0",
                                     n_bytes));
      return 0;
   end
...
function void uvm_reg_mem_map::set_submap_offset(uvm_reg_mem_map submap, uvm_reg_mem_addr_t offset);
  assert(submap != null);
...
function uvm_reg_mem_addr_t uvm_reg_mem_map::get_submap_offset(uvm_reg_mem_map submap);
  assert(submap != null);
  if (!m_submaps.exists(submap)) begin
    `uvm_error("RegMem",{"Map '",submap.get_full_name(),
...
function void uvm_reg_mem_map::Xinit_address_mapX();
     ...
     if (!m_mems_info[mem].unmapped) begin
       ...
       foreach (addrs[i]) begin
         ...
         if (top_map.m_regs_by_offset.exists(addr)) begin
           string a;
           a = $sformatf("%0h",addr);
           `uvm_warning("RegMem", {"In map '",get_full_name(),"' memory '",
...
function void uvm_reg_mem_map::set_attribute(string name, string value);

   if (name == "") begin
      `uvm_error("RegMem", {"Cannot set attribute with empty name for map ",
         get_full_name(),"'."})
      return;
   end
   ...
   if (m_attributes.exists(name)) begin
      if (value != "") begin
         `uvm_warning("RegMem", {"Redefining attribute '",
...
function string uvm_reg_mem_map::get_attribute(string name, bit inherited = 1);
...
function void uvm_reg_mem_map::get_attributes(ref string names[string],
                                          input bit inherited = 1);
   if (inherited && m_parent_map != null)
...
function void uvm_reg_mem_map::do_print (uvm_printer printer);
...
function string uvm_reg_mem_map::convert2string();
   uvm_reg  regs[$];
   uvm_vreg vregs[$];
   uvm_mem  mems[$];
   uvm_endianness_e endian;
...
function uvm_object uvm_reg_mem_map::clone();
  //uvm_rap_map me;
  //me = new this;
  //return me;
  return null;
...
function void uvm_reg_mem_map::do_copy (uvm_object rhs);
  //uvm_reg_mem_map rhs_;
