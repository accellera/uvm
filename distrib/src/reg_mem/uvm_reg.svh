...
virtual class uvm_reg extends uvm_object;
   ...
   //
   extern virtual function void     configure  (uvm_reg_mem_block blk_parent,
   ...
   /*local*/ extern virtual function void add_map    (uvm_reg_mem_map map);
   ...
   // address map, an error message is issued.
   //
   extern virtual function uvm_reg_mem_addr_t  get_offset      (uvm_reg_mem_map map = null);
   ...
   // address map, an error message is issued.
   //
   extern virtual function uvm_reg_mem_addr_t  get_address     (uvm_reg_mem_map map = null);
   ...
   // address map, an error message is issued.
   //
   extern virtual function int             get_addresses   (uvm_reg_mem_map map = null,
   ...
   // register.
   //
   extern virtual function bit predict (uvm_reg_mem_data_t  value,
   ...
   extern local virtual function void Xpredict_readX (uvm_reg_mem_data_t  value,
                                                      uvm_path_e path,
                                                      uvm_reg_mem_map     map);

   extern local virtual function void Xpredict_writeX(uvm_reg_mem_data_t  value,
                                                      uvm_path_e path,
                                                      uvm_reg_mem_map     map);
   ...
   // abstraction class in the RegMem model.
   ...
   //
   extern virtual function void set (uvm_reg_mem_data_t  value,
                                     string          fname = "",
                                     int             lineno = 0);
   ...
   //
   extern virtual function uvm_reg_mem_data_t  get(string  fname = "",
                                               int     lineno = 0);
   ...
   // must be specified.
   //
   extern function uvm_reg_frontdoor get_frontdoor(uvm_reg_mem_map map = null);
   ...
   //
   virtual local function void sample(uvm_reg_mem_data_t  data,
                                      bit             is_read,
                                      uvm_reg_mem_map     map);
   endfunction
   ...
   // field callbacks
   //--------------------------------------------------------------------------
   virtual task pre_write(ref uvm_reg_mem_data_t  wdat,
                          ref uvm_path_e path,
   ...
   // field callbacks
   //--------------------------------------------------------------------------
   virtual task post_write(uvm_reg_mem_data_t        wdat,
                           uvm_path_e       path,
                           uvm_reg_mem_map           map,
   ...
   // field callbacks
   //--------------------------------------------------------------------------
   virtual task post_read(ref uvm_reg_mem_data_t    rdat,
                          input uvm_path_e path,
                          input uvm_reg_mem_map     map,
                          ref uvm_status_e status);
   endtask
...
function uvm_reg::new(string name="", int unsigned n_bits, int has_cover);
   super.new(name);
   if (n_bits == 0) begin
      `uvm_error("RegMem", $psprintf("Register \"%s\" cannot have 0 bits", this.get_name()));
      n_bits = 1;
   end
   if (n_bits > `UVM_REG_MEM_DATA_WIDTH) begin
      `uvm_error("RegMem", $psprintf("Register \"%s\" cannot have more than %0d bits (%0d)", this.get_name(), `UVM_REG_MEM_DATA_WIDTH, n_bits));
...
function void uvm_reg::configure(uvm_reg_mem_block blk_parent, uvm_reg_file rf_parent, string hdl_path = "");
...
function void uvm_reg::add_field(uvm_reg_field field);
   ...
   if (this.locked) begin
      `uvm_error("RegMem", "Cannot add field to locked register model");
      return;
   end

   if (field == null) `uvm_fatal("RegMem", "Attempting to register NULL field");
   ...
   if (this.n_used_bits > this.n_bits) begin
      `uvm_error("RegMem", $psprintf("Fields use more bits (%0d) than available in register \"%s\" (%0d)",
   ...
   if (idx > 0) begin
      if (this.fields[idx-1].get_lsb_pos_in_register() +
         ...
         `uvm_error("RegMem", $psprintf("Field %s overlaps field %s in register \"%s\"",
...
function uvm_reg_frontdoor uvm_reg::get_frontdoor(uvm_reg_mem_map map = null);
   uvm_reg_mem_map_info map_info;
...
function uvm_reg_backdoor uvm_reg::get_backdoor(bit inherit = 1);
...
function void uvm_reg::get_hdl_path(ref uvm_hdl_path_concat paths[$],
  ...
  if (!has_hdl_path(kind)) begin
    `uvm_error("RegMem",{"Register does not have hdl path defined for abstraction '",kind,"'"})
    return;
  end
...
function void uvm_reg::set_parent(uvm_reg_mem_block blk_parent,
                                      uvm_reg_file rf_parent);
...
function uvm_reg_mem_block uvm_reg::get_parent();
  return get_block();
endfunction
...
function void uvm_reg::add_map(uvm_reg_mem_map map);
  if (!maps.exists(map))
    maps[map] = 1;
endfunction
...
function void uvm_reg::get_maps(ref uvm_reg_mem_map maps[$]);
...
function bit uvm_reg::is_in_map(uvm_reg_mem_map map);
   if (maps.exists(map))
     return 1;
...
function uvm_reg_mem_map uvm_reg::get_local_map(uvm_reg_mem_map map, string caller="");
   if (map == null)
...
function uvm_reg_mem_map uvm_reg::get_default_map(string caller="");
...
function string uvm_reg::get_rights(uvm_reg_mem_map map = null);
...
function uvm_reg_mem_block uvm_reg::get_block();
...
function uvm_reg_mem_addr_t uvm_reg::get_offset(uvm_reg_mem_map map = null);
   ...
   if (map_info.unmapped) begin
      `uvm_warning("RegMem", {"Register '",get_name(),
                   "' is unmapped in map '",
...
function int uvm_reg::get_addresses(uvm_reg_mem_map map=null, ref uvm_reg_mem_addr_t addr[]);
...
function uvm_reg_mem_addr_t uvm_reg::get_address(uvm_reg_mem_map map = null);
...
function uvm_reg_field uvm_reg::get_field_by_name(string name);
   ...
   `uvm_warning("RegMem", $psprintf("Unable to locate field \"%s\" in register \"%s\".",
                                    name, this.get_name()));
...
function void uvm_reg::set_attribute(string name,
                                         string value);
   if (name == "") begin
      `uvm_error("RegMem", {"Cannot set anonymous attribute \"\" in register '",
                         get_full_name(),"'"})
      return;
   end
   ...
   if (this.attributes.exists(name)) begin
      if (value != "") begin
         `uvm_warning("RegMem", {"Redefining attribute '",name,"' in register '",
...
function void uvm_reg::Xadd_constraintsX(string name);
   ...
   if (this.locked) begin
      `uvm_error("RegMem", "Cannot add constraints to locked register model");
      return;
   end
...
function int uvm_reg::set_cover(int is_on);
   ...
   if ((this.has_cover & is_on) == 0) begin
      `uvm_warning("RegMem", $psprintf("Register \"%s\" - Cannot turn ON any coverage becasue the corresponding coverage model was not generated.", this.get_full_name()));
      return this.cover_on;
   end
   ...
   if (is_on & UVM_REG_BITS) begin
      if (this.has_cover & UVM_REG_BITS) begin
          ...
          `uvm_warning("RegMem", $psprintf("Register \"%s\" - Cannot turn ON Register Bit coverage becasue the corresponding coverage model was not generated.", this.get_full_name()));
      end
   end
   ...
   if (is_on & UVM_FIELD_VALS) begin
      if (this.has_cover & UVM_FIELD_VALS) begin
          ...
          `uvm_warning("RegMem", $psprintf("Register \"%s\" - Cannot turn ON Field Value coverage becasue the corresponding coverage model was not generated.", this.get_full_name()));
      end
   end
   ...
   if (is_on & UVM_ADDR_MAP) begin
      if (this.has_cover & UVM_ADDR_MAP) begin
          ...
          `uvm_warning("RegMem", $psprintf("Register \"%s\" - Cannot turn ON Address Map coverage becasue the corresponding coverage model was not generated.", this.get_full_name()));
      end
   end
...
function void uvm_reg::set(uvm_reg_mem_data_t  value,
                               string          fname = "",
                               int             lineno = 0);
...
function bit uvm_reg::predict(uvm_reg_mem_data_t  value,
                                  uvm_predict_e kind = UVM_PREDICT_DIRECT,
                                  uvm_path_e path = UVM_BFM,
                                  uvm_reg_mem_map     map = null,
                                  string          fname = "",
   ...
   if (this.Xis_busyX && kind == UVM_PREDICT_DIRECT) begin
      `uvm_warning("RegMem", $psprintf("Trying to predict value of register \"%s\" while it is being accessed",
                                    this.get_full_name()));
      return 0;
   end
...
function uvm_reg_mem_data_t  uvm_reg::get(string  fname = "",
                                          int     lineno = 0);
...
function void uvm_reg::Xpredict_readX(uvm_reg_mem_data_t  value,
                                   uvm_path_e path,
                                   uvm_reg_mem_map  map);
   // Fields are stored in LSB to MSB order
   foreach (this.fields[i]) begin
...
function void uvm_reg::Xpredict_writeX(uvm_reg_mem_data_t  value,
                                   uvm_path_e path,
                                   uvm_reg_mem_map  map);
   int j, w;
...
task uvm_reg::XwriteX(output uvm_status_e status,
   ...
   status = UVM_NOT_OK;
   value &= value << (`UVM_REG_MEM_DATA_WIDTH - n_bits) >> (`UVM_REG_MEM_DATA_WIDTH - n_bits);
   value &= ((1 << n_bits)-1);
   ...
   begin : pre_write_callbacks
      uvm_reg_mem_data_t  tmp;
      uvm_reg_mem_data_t  msk;
      int lsb;
   ...
   case (path)
      ...
      // ...VIA USER BACKDOOR
      UVM_BACKDOOR: begin
         uvm_reg_mem_data_t  reg_val;
         uvm_reg_mem_data_t  final_val;
      ...
      UVM_BFM: begin
         ...
         // ...VIA BUILT-IN FRONTDOOR
            ...
            if (parent == null)
              `uvm_fatal("RegMem","Built-in frontdoor write requires non-null parent argument")

            if (map_info.unmapped) begin
               `uvm_error("RegMem", {"Register '",get_full_name(),"' unmapped in map '",
   ...
   begin
      ...
      uvm_reg_mem_data_t  msk;
      int lsb;
      uvm_reg_mem_data_t predicted_value;
   ...
   `uvm_info("RegMem", $psprintf("Wrote register \"%s\" via %s: 'h%0h",
              this.get_full_name(),
              (path == UVM_BFM) ? {"map ",map.get_full_name()} : 
...
task uvm_reg::XreadX(output uvm_status_e status,
   ...
   case (path)
      ...
      UVM_BACKDOOR: begin
         ...
         if (status == UVM_IS_OK || status == UVM_HAS_X) begin
            uvm_reg_mem_data_t  wo_mask = 0;

            foreach (this.fields[i]) begin
               string acc = this.fields[i].get_access(uvm_reg_mem_map::backdoor);
               if (acc == "RC") begin
      ...
      UVM_BFM: begin
         ...
         // ...VIA BUILT-IN FRONTDOOR
            ...
            if (parent == null)
              `uvm_fatal("RegMem","Built-in frontdoor read requires non-null parent argument")
...
task uvm_reg::poke(output uvm_status_e status,
   ...
   if (this.backdoor == null && !has_hdl_path(kind)) begin
      `uvm_error("RegMem", $psprintf("No backdoor access available to poke register \"%s\"", this.get_name()));
      status = UVM_NOT_OK;
   ...
   `uvm_info("RegMem", $psprintf("Poked register \"%s\": 'h%h",
...
task uvm_reg::peek(output uvm_status_e status,
   ...
   if (!this.Xis_locked_by_fieldX) this.XatomicX(1);
   if (this.backdoor == null && !has_hdl_path(kind)) begin
      `uvm_error("RegMem", $psprintf("No backdoor access available to peek register \"%s\"", this.get_name()));
      status = UVM_NOT_OK;
      if(!this.Xis_locked_by_fieldX)
        this.XatomicX(0);
      return;
   ...
   `uvm_info("RegMem", $psprintf("Peeked register \"%s\": 'h%h",
                              this.get_full_name(), value),UVM_MEDIUM);
...
task uvm_reg::mirror(output uvm_status_e  status,
                         ...
                         input  string             fname = "",
                         input  int                lineno = 0);
   uvm_reg_mem_data_t  v;
   uvm_reg_mem_data_t  exp;
   this.fname = fname;
   this.lineno = lineno;
   ...
   if (check == UVM_CHECK) begin
      ...
      if ((v|dc) !== (exp|dc)) begin
         `uvm_error("RegMem", $psprintf("Register \"%s\" value read from DUT (0x%h) does not match mirrored value (0x%h)",
...
function uvm_object uvm_reg::clone();
  `uvm_fatal("RegMem","RegMem registers cannot be cloned")
  return null;
endfunction
...
function void uvm_reg::do_copy(uvm_object rhs);
  `uvm_fatal("RegMem","RegMem registers cannot be copied")
endfunction
...
function bit uvm_reg::do_compare (uvm_object  rhs,
                                        uvm_comparer comparer);
  `uvm_warning("RegMem","RegMem registers cannot be compared")
  return 0;
endfunction
...
function void uvm_reg::do_pack (uvm_packer packer);
  `uvm_warning("RegMem","RegMem registers cannot be packed")
endfunction
...
function void uvm_reg::do_unpack (uvm_packer packer);
  `uvm_warning("RegMem","RegMem registers cannot be unpacked")
endfunction
