...
class uvm_mem_backdoor extends uvm_object;
   ...
   protected task do_pre_read(input uvm_mem       mem,
                              inout uvm_reg_mem_addr_t    offset,
                              input uvm_sequence_base parent,
                              input uvm_object        extension);
...
virtual class uvm_reg_backdoor_cbs extends uvm_callback;
   ...
   //--------------------------------------------------------------------------
    virtual function uvm_reg_mem_data_t  encode(uvm_reg_mem_data_t data);
      return data;
    endfunction
   ...
   // By default, the data is not modified.
   //--------------------------------------------------------------------------
    virtual function uvm_reg_mem_data_t  decode(uvm_reg_mem_data_t data);
      return data;
    endfunction
...
task uvm_reg_backdoor::wait_for_change(uvm_reg rg);
   `uvm_fatal("RegMem", "uvm_reg_backdoor::wait_for_change() method has not been overloaded");
endtask
      ...
      begin
         ...
         forever begin
            ...
            if (status != UVM_IS_OK) begin
               `uvm_error("RegMem", $psprintf("Backdoor read of register '%s' failed.",
                          rg.get_name()));
            end
            foreach (fields[i]) begin
               if (this.is_auto_updated(fields[i])) begin
                  uvm_reg_mem_data_t  fld_val
...
task uvm_reg_backdoor::write(input  uvm_reg       rg,
   ...
   `uvm_fatal("RegMem", "uvm_reg_backdoor::write() method has not been overloaded");
...
function uvm_status_e uvm_reg_backdoor::read_func(
                            ...
                            input  uvm_sequence_base parent,
                            input  uvm_object        extension);
   `uvm_fatal("RegMem", "uvm_reg_backdoor::read_func() method has not been overloaded");
   return UVM_NOT_OK;
endfunction
...
task uvm_mem_backdoor::write(input  uvm_mem       mem,
   ...
   `uvm_fatal("RegMem", "uvm_mem_backdoor::write() method has not been overloaded");
...
function uvm_status_e uvm_mem_backdoor::read_func(
                                       ...
                                       input  uvm_sequence_base parent,
                                       input  uvm_object        extension);
   `uvm_fatal("RegMem", "uvm_mem_backdoor::read_func() method has not been overloaded");
   return UVM_NOT_OK;
endfunction
