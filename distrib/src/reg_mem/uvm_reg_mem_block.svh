...
function uvm_reg_field uvm_reg_mem_block::get_field_by_name(string name);
   ...
   foreach (blks[blk_]) begin
	uvm_reg_mem_block blk = blk_;
	uvm_reg_field field field = blk.get_field_by_name(name);
...
function uvm_reg_backdoor uvm_reg_mem_block::get_backdoor(bit inherit_ = 1);
