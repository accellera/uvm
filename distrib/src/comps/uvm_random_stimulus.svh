...
//------------------------------------------------------------------------------
// CLASS: uvm_random_stimulus_ieee #(T)
//
// A general purpose unidirectional random stimulus class.
//
// The uvm_random_stimulus_ieee class generates streams of T transactions. These streams
...
class uvm_random_stimulus_ieee #(type T=uvm_transaction) extends uvm_component;

  const static string type_name = "uvm_random_stimulus_ieee #(T)";

  typedef uvm_random_stimulus_ieee #(T) this_type;
...
endclass : uvm_random_stimulus_ieee
