...
class uvm_barrier extends uvm_object;
  ...
  virtual function void do_print (uvm_printer printer);
    printer.print_integral("threshold", threshold, $bits(threshold), UVM_DEC, ".", "int");
    printer.print_integral("num_waiters", num_waiters, $bits(num_waiters), UVM_DEC, ".", "int");
    printer.print_integral("at_threshold", at_threshold, $bits(at_threshold), UVM_BIN, ".", "bit");
    printer.print_integral("auto_reset", auto_reset, $bits(auto_reset), UVM_BIN, ".", "bit");
  endfunction
