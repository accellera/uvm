...
`endif
  ...
  // Function: set_response_queue_error_report_enabled
  //
  // By default, if the internal esponse queue overflows, an error is
  ...
  // Function: get_response_queue_error_report_enabled
  //
