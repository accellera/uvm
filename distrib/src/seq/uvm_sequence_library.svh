...
function void uvm_sequence_library::do_print(uvm_printer printer);
   printer.print_integral("min_random_count",min_random_count,32,UVM_DEC,,"int unsigned");
   printer.print_integral("max_random_count",max_random_count,32,UVM_DEC,,"int unsigned");
   printer.print_generic("selection_mode","uvm_sequence_lib_mode",32,selection_mode.name());
   printer.print_integral("sequence_count",sequence_count,32,UVM_DEC,,"int unsigned");
   ...
   foreach (seqs_distrib[typ]) begin
     printer.print_integral({"[",typ,"]"},seqs_distrib[typ],32,,UVM_DEC,"int unsigned");
   end
   printer.print_array_footer();
endfunction
