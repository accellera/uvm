...
class uvm_sequencer_param_base #(type REQ = uvm_sequence_item,
  ...
  /* local */ extern virtual function void build    ();
  /* local */ extern virtual function void connect  ();
...
function void uvm_sequencer_param_base::connect();
...
function void uvm_sequencer_param_base::build();
  super.build();
