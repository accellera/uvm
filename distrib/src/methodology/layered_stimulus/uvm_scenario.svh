...
virtual class uvm_scenario #(type REQ = uvm_sequence_item, type RSP = REQ) extends uvm_sequence #(REQ, RSP);

  uvm_scenario_controller_base m_scenario_controller;
  uvm_scenario_controller #(REQ, RSP) param_scenario_controller;
  ...
  virtual task start(uvm_scenario_controller_base sequencer,
                     uvm_scenario_base parent_sequence = null,
