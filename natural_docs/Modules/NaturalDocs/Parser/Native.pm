    ...
    while ($index < $endingIndex)
        ...
        # If we're not in either code style...
            ...
            # If the line looks like an inline image...
                ...
                $output .= '<img mode="inline" src="' . NaturalDocs::NDMarkup->ConvertAmpChars($2) . '" '
    ...
    while ($index < scalar @textBlocks)
        ...
        if ($textBlocks[$index] eq "\x1E")
            ...
            if ($endingIndex != -1)
                ...
                if ($linkText =~ /^(?:mailto\:)?((?:[a-z0-9\-\_]+\.)*[a-z0-9\-\_]+@(?:[a-z0-9\-\_]+\.)+[a-z]{2,4})$/i)
