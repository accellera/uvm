...
class test extends uvm_test;
  ...
  begin
    ...
    $write("UVM TEST - WARNING expected since re_registering a severity catcher\n");
    ...
    $write("UVM TEST - WARNING expected since re_registering an ID catcher\n");
    ...
    $write("UVM TEST - WARNING expected since re_registering a severity/ID catcher\n");
