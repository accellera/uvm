...
class test extends uvm_test;
   ...
   virtual task run_phase(uvm_phase phase);
      ...
      $display("Testing set-mirror. Reg value should be 0, not the set value.");

      $display("set...");
      env.regmodel.r1.set(32'hFFFF_FFFF);
      $display("mirror...");
      ...
      $display("set...");
      env.regmodel.r1.set(32'hAAAA_AAAA);
      $display("update...");
      env.regmodel.r1.update(status);
      if (status != UVM_IS_OK) begin
         `uvm_error("TEST", "Status not OK after update!")
      end
