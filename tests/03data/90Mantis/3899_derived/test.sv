...
class agent_config_ext extends agent_config;     
   `uvm_object_utils_begin(agent_config_ext)
   `uvm_object_utils_end   
...
class my_class_ext extends my_class;
       agent_config_ext ext_config;

  `uvm_component_utils_begin(my_class_ext)
  `uvm_component_utils_end
...
class test extends uvm_test;  
   ...
   virtual function void build_phase(uvm_phase phase);
    ...
    c1   = my_class_ext::type_id::create("class_a1", this);    
  ...
  endtask
   ...
   `uvm_new_func
    ...
    function void report_phase(uvm_phase phase);
       if ((cfg == null) || (c1.parent_config == null ))
