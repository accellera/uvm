...
// Example: VMM on top
//
// This example demonstrates a advanced verification using VMM implicit phasing, 
// where VMM controls the phasing of UVM and any integrated VMM  groups.
//
//------------------------------------------------------------------------------
...
`ifndef NO_VMM_12
program example_07_vmm_on_top_implicit_phasing;
   bit reset =0;
 ...
 endclass // uvm_as_child
  ...
  class MyEnv extends vmm_group;
	...
	`vmm_note(log, `vmm_sformatf("TESTCODE: VMM Connect complete"));
     ...
     task reset_ph();
	example_07_vmm_on_top_implicit_phasing.reset <= 1;
	#100 example_07_vmm_on_top_implicit_phasing.reset <= 0;
...
endprogram // example_07_vmm_on_top_implicit_phasing
`endif //  `ifndef NO_VMM_12
