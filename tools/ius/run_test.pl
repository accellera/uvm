...
sub run_the_test {
  ...
  $ius = "irun -uvmhome $uvm_home -uvmnoautocompile $uvm_home/src/dpi/uvm_dpi.cc -incdir $uvm_home/src $uvm_home/src/uvm_pkg.sv $ius_comp_opts $ius_sim_opts test.sv +UVM_TESTNAME=test";
