...
sub run_the_test {
  ...
  $ius = "irun -uvm -uvmhome $uvm_home -uvmnoautocompile  -timescale 1ns/1ns $uvm_home/src/dpi/uvm_dpi.c +incdir+$uvm_home/src $uvm_home/src/uvm_pkg.sv test.sv -l irun.log $ius_comp_opts $ius_sim_opts +UVM_TESTNAME=test";
