...
sub run_the_test {
  ...
  $vcs = "$vcs_bin -sverilog +acc +vpi -timescale=1ns/1ns +incdir+$uvm_home/src $uvm_home/src/uvm_pkg.sv test.sv $uvm_home/src/dpi/uvm_dpi.c -CFLAGS -DVCS -l vcs.log $vcs_opts";
